...
def run(playwright: Playwright) -> None:
    ...
    expect(home_page.email).to_be_visible()
    ...
    expect(home_page.email).to_be_hidden()
    expect(home_page.password).to_be_hidden()
    expect(home_page.sign_in_button).to_be_hidden()
